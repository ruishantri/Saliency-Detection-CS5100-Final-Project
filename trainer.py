...
class Trainer():
    def __init__(self, args, save_path):
        ...
        self.tr_img_folder = os.path.join(args.data_path, args.dataset, '/Users/anandhegde/Documents/NEU/FAI/Project work/TRACER/Train/images')
        self.tr_gt_folder = os.path.join(args.data_path, args.dataset, '/Users/anandhegde/Documents/NEU/FAI/Project work/TRACER/Train/masks')
...
class Tester():
    def __init__(self, args, save_path):
        ...
        self.test_loader = get_loader(te_img_folder, te_gt_folder, phase='test',
                                      batch_size=args.batch_size, shuffle=False,
                                      num_workers=args.num_workers, transform=self.test_transform)
